...
import {ClosePopup, CreateFolder, CreateFolderPopupActionTypes} from '../actions/create-folder-popup.actions';
import {catchError, switchMap, withLatestFrom} from 'rxjs/operators';
import {GetContent} from '../actions/command-panel.actions';
